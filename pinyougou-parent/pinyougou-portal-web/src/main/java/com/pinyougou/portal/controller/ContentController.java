...
import com.pinyougou.content.servie.ContentService;
...
public class ContentController {
	...
	public List<TbContent> findByContentId(Long categoryId){
		return contentService.findByContentId(categoryId);
	}
