            ...
            <div class="fl preview-wrap">
                ...
                <div class="zoom">
                    ...
                    <div id="preview" class="spec-preview">
                        <span class="jqzoom">
                            <#if (imageList?size>0)>
                                <img jqimg="${imageList[0].url}" src="${imageList[0].url}"  width="450px" height="450px" />
                            </#if>
                        </span>
                    </div>
                    <!--下方的缩略图-->
...
<#--                            <dd><a class="selected">金色<span title="点击取消选择">&nbsp;</span>-->
<#--                                </a></dd>-->
                            <#list specification.attributeValue as value>
                            <dd><a class="{{isSelected('${specification.attributeName}','${value}')?'selected':''}}" ng-click="selectSpecification('${specification.attributeName}','${value}')" > ${value}
                    ...
                    <div class="summary-wrap">
                        ...
                        <div class="fl">
                            <ul class="btn-choose unstyled">
                                <li>
                                    <a href="http://localhost:9107/cart.html" target="_blank" class="sui-btn  btn-danger addshopcar" ng-click="addToCart()">加入购物车</a>
                                </li>
                            </ul>
                        </div>
                    </div>
